...
public class CategoryController {
    ...
    public String delete(@PathVariable("id")int id,HttpServletRequest request) throws Exception{
        ...
        File imageFold = new File(request.getServletContext().getRealPath("img/category"));
        File file = new File(imageFold,id+".jpg");
        file.delete();
        return null;
    }
    ...
    public Object update( MultipartFile image,HttpServletRequest request,Category bean) throws Exception {
